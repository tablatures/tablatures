...
>
	<div class="pointer-events-none absolute w-full flex justify-end mouse">
		<button class="mx-1 pointer-events-auto ">
		...
		<a href="{base}/" class="rounded border border-stone-500  mx-2 pointer-events-auto">
